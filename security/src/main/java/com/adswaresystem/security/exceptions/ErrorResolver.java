...
public class ErrorResolver {
  ...
  /**
   * Method to resolve not found exception.
   * 
   * @param request the request
   * @param ex the exception
   * @return the exception
  ...
  public ErrorResponse resolveNotFoundException(HttpServletRequest request,
      NotFoundException ex) {
	  
	  ErrorResponse errorResponse = new ErrorResponse();
	  
	  errorResponse.setType(ErrorType.ERROR.name());
	  errorResponse.setCode(Constants.ERROR_CODE_NOT_FOUND);
